            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="text" id="slug" name="slug" value="{{ old('title') }}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        <input type="file" accept="image/*" class="custom-file-input" id="cover_image" name="cover_image">
