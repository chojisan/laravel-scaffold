<template>
  <div class="bg-gray-50 dark:bg-gray-900">
    <nav class="z-20 fixed h-15 w-full bg-white shadow">
    ...
    <div class="h-screen pt-15 flex dark:bg-gray-900">
      <!-- Page Sidebar -->
      <aside
      ...
      <div class="flex flex-col flex-1 w-full h-full pb-16 overflow-y-auto">
